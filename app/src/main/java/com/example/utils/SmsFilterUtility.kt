...
object SmsFilterUtility {
    ...
    private val INCLUSION_KEYWORDS = listOf("debited", "credited", "spent", "received", "deducted", "sent", "paid", "withdrawn", "transfer", "transfered", "transferred", "payment", "charge", "charged", "txn")
